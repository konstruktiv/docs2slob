...
This script converts documentation retrieved from DevDocs to a [[https://github.com/itkach/slob][Slob]]
file, for offline usage with the [[https://github.com/itkach/aard2-android][Aard2]] dictionary app.
